...
public class AntiFeetplace extends Module {
    ...
    // wait while chest present (stop mining the below; keep surround open)
    ...
    // keep retargeting the surround while chest exists so the hole stays open
    ...
    // obsidian bridge for crystal base (enemy -> surround -> chest -> obsidian -> you)
    ...
    // filters (defaults match the recommended config)
